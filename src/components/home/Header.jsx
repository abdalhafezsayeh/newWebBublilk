...
const Header = () => {
  ...
  return (
    <>
        ...
        <Container className="absolute top-1/2 z-10 -translate-y-1/2 left-1/2 -translate-x-1/2 h-[90%] flex gap-3">
          <div className="w-[57%] lg:w-[40%] lg:min-w-[450px] grid grid-cols-[20%_auto] lg:grid-cols-[22%_auto] bg-white rounded ">
            ...
            <div className="w-full rounded">
              ...
              {travelType == "taxi" && <TaxiForm setShowModalNotLogin={setShowModalNotLogin} setReqId={setReqId} setShowSuccess={setShowSuccess} />}
            </div>
          </div>
        </Container>
      ...
      {/* Start Login  */}
      <ModalCom visible={showModalNotLogin} onClose={()=> setShowModalNotLogin(false)}>
        <div className="flex flex-col gap-5 items-center justify-center bg-white p-5 rounded-b-xl">
          <img 
            src="/home/loginFirst.gif"
            alt="taxi Ferney Voltaire login animate"
            className="object-contain w-1/2"
          />

          <h3 className="capitalize text-lg text-center font-bold tracking-wider">
          ...
          <button 
            ...
            className="py-2 text-center w-2/3 rounded-md bg-main border border-main text-white hover:bg-transparent hover:text-main duration-300"
          >
            Sign Up
          </button>
      ...
      {/* login modal */}
      <ModalCom visible={showModalLogin} onClose={()=> setShowModalLogin(false)}>
        <Login
          handelNext={() => {
      ...
      {/* sign up modal */}
      <ModalCom visible={showModalSignUp} onClose={()=> setShowModalSignUp(false)}>
